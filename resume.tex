...
\address{MENTOR, Society of Robotics | Co-Head, Hospitality Team, Cultural Council}

\mobile{8527281066}
\email{hiteshdureja03@gmail.com}
%\dateofbirth{January 1st, 1970}
% \homepage{www.posquit0.com} 
\github{github.com/hiteshdureja}
\linkedin{linkedin.com/in/hitesh-dureja-78627a202}
% \gitlab{gitlab-id}
...
%-------------------------------------------------------------------------------
% \input{cv/summary.tex} %Personal Profile
\input{cv/projects.tex}
\input{cv/achievements.tex}
\input{cv/skills.tex}
\input{cv/publications.tex}
\input{cv/education.tex}
\input{cv/experience} %POSITIONS OF RESPONSIBILITY
\input{cv/interests.tex} %Extra‑Curricular Activities and Interests
